...
class ApiController extends CommonController
{
    ...
    public function download()
    {
        ...
        header('location:http://' . $_SERVER['HTTP_HOST'] . '/phpx6xsqii9/upload/' . $fileName);
        exit; 
    }
    /**
     * 获取某表的某个字段列表接口
    ...
    public function group($tablesName,$columnName){
        ...
        if ($tokens['isAdmin']!=1 || ($tokens['isAdmin']==1 && $tokens['tablename'] != "users")){
            ...
            if($tokens['tablename'] == 'zulinhetong'){
                if($tokens['tablename'] == 'fangdong'){
                    $where .= " and `fangdongzhanghao` = '".$tokens['username']."' ";
                }
            }
            ...
            if($tokens['tablename'] == 'kanfangjilu'){
                if($tokens['tablename'] == 'fangdong'){
                    $where .= " and `fangdongzhanghao` = '".$tokens['username']."' ";
                }
            }
            ...
            if($tokens['tablename'] == 'lianxijilu'){
                if($tokens['tablename'] == 'fangdong'){
                    $where .= " and `fangdongzhanghao` = '".$tokens['username']."' ";
                }
            }
            ...
            if($tokens['tablename'] == 'tuifangjilu'){
                if($tokens['tablename'] == 'fangdong'){
                    $where .= " and `fangdongzhanghao` = '".$tokens['username']."' ";
                }
            }
    ...
    public function value($tableName,$xColumnName,$yColumnName,$tjType){
        ...
        $where = " where 1 ";
        if ($tokens['isAdmin']!=1 || ($tokens['isAdmin']==1 && $tokens['tablename'] != "users")){
            if($tableName == 'fangwuzulin'){
                if($tokens['tablename'] == 'fangdong'){
                    $where .= " and `fangdongzhanghao` = '".$tokens['username']."' ";
                }
            }
            if($tableName == 'zufangjilu'){
                if($tokens['tablename'] == 'fangdong'){
                    $where .= " and `fangdongzhanghao` = '".$tokens['username']."' ";
                }
            }
