		...
		<template v-if="showFlag">
			...
			<div :style='{"border":"0px solid #eee","padding":"0","boxShadow":"0 1px 10px 1px rgba(115,108,203,.1)","margin":"30px 0 0","borderRadius":"0px","background":"rgba(255,255,255,.9)","width":"100%"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='true' prop="hetongfengmian" width="200" label="合同封面">
						<template slot-scope="scope">
							<div v-if="scope.row.hetongfengmian">
								<img v-if="scope.row.hetongfengmian.substring(0,4)=='http'" :src="scope.row.hetongfengmian.split(',')[0]" width="100" height="100" style="object-fit: cover" @click="imgPreView(scope.row.hetongfengmian.split(',')[0])">
								<img v-else :src="$base.url+scope.row.hetongfengmian.split(',')[0]" width="100" height="100" style="object-fit: cover" @click="imgPreView($base.url+scope.row.hetongfengmian.split(',')[0])">
							</div>
							<div v-else>无图片</div>
						</template>
					</el-table-column>
