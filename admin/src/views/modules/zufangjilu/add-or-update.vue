	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"14px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="房屋类型" prop="fangwuleixing">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="租赁月数" prop="zulinyueshu">
					<el-input v-model.number="ruleForm.zulinyueshu" placeholder="租赁月数" clearable  :readonly="ro.zulinyueshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="租赁月数" prop="zulinyueshu">
					<el-input v-model="ruleForm.zulinyueshu" placeholder="租赁月数" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="租房押金" prop="zufangyajin">
					<el-input v-model.number="ruleForm.zufangyajin" placeholder="租房押金" clearable  :readonly="ro.zufangyajin"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="租房押金" prop="zufangyajin">
					<el-input v-model="ruleForm.zufangyajin" placeholder="租房押金" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="订单金额" prop="dingdanjine">
					<el-input v-model="dingdanjine" placeholder="订单金额" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.dingdanjine" label="订单金额" prop="dingdanjine">
					<el-input v-model="ruleForm.dingdanjine" placeholder="订单金额" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="租房状态" prop="zufangzhuangtai">
					<el-select :disabled="ro.zufangzhuangtai" v-model="ruleForm.zufangzhuangtai" placeholder="请选择租房状态" >
						<el-option
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="租房状态" prop="zufangzhuangtai">
...
export default {
	...
	computed: {
		...
		dingdanjine:{
			...
			get: function () {
				return 1*this.ruleForm.zujin*this.ruleForm.zulinyueshu+parseFloat(this.ruleForm.zufangyajin==""?0:this.ruleForm.zufangyajin)
			}
		},
	},
    components: {
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				this.ruleForm.zufangyajin = Number('1000'); 				this.ruleForm.zufangzhuangtai = '未退房'; 			}
			// 获取用户信息
			this.$http({
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `zufangjilu/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.zufangjiluCrossAddOrUpdateFlag = false;
											this.parent.search();
